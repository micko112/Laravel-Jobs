...
<div class="min-h-full">
    <nav class="bg-gray-800">
        ...
        <div class="md:hidden" id="mobile-menu">
            <div class="space-y-10 px-2 pt-2 pb-3 sm:px-3">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="/"
                   class= {{request()->is(("/")) ?'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"rounded-md px-3 py-2 text-sm font-medium " aria-current="page">Home</a>
                <a href="/about"
